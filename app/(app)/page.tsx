...
export default function HomePage() {
  return (
    <main className="flex-1 bg-neutral-50 p-4 sm:p-10 sm:py-12">
      <h1 className="text-2xl font-bold">Learn Spanish By Topic</h1>
      <div className="mt-4 grid grid-cols-1 overflow-hidden rounded-lg sm:mt-12 sm:grid-cols-4 sm:gap-10">
        {decks.map(deck => {
          return (
