...
import { resetEmailSchema, ResetEmailValues } from './reset-email-schema';
...
export default function ResetEmailForm() {
  ...
  async function onSubmit(values: ResetEmailValues) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span>{isSubmitting ? 'Resetting...' : 'Reset Email'}</span>
      </button>
    </form>
  );
}
